...
/**
 * A functor struct for comparing elements of the PriorityQueue.
 *
...
struct MyComparator {
    /**
     * Compares two elements and returns the difference.
     *
...
public:
     ...
     *
     * Adds a new element to the priority queue while maintaining the order
     ...
     * priority queue. The element is removed from the front of the linked list.
     *
